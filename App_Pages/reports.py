...
def fetch_report_data():
    ...
    SELECT
        ...
        cd.awbNum AS 'AWB Number',
        cd.awbDate AS 'AWB Date',
        cd.route AS 'Route',
    ...
    # Data Types (AWB DATE only)
    df["AWB Date"] = pd.to_datetime(df["AWB Date"], errors="coerce").dt.date
...
def reports_page():
    ...
    # Reorder Columns
    preferred_order = [
        "Insurance Number", "Year", "AWB Number", "AWB Date",
    ...
    def download_excel(df):
        ...
        # Insert Logo
        logo = XLImage("Assets/Cargo_Claims_Manager_Blue_logo.png")  # path or absolute path
        logo.width  = int(555 * 0.75)   # ≈ 1578
        logo.height = int(60 * 0.75)    # ≈ 165
        ws.add_image(logo, "A1")

        # Custom Header Text
        ws["A3"] = "Insurance Claims Report"
    ...
    if st.button("Generate Report"):
        #Generate excel
        st.session_state.excel_file = download_excel(filtered_df)

        # Generate pdf
        st.session_state.pdf_file = excel_to_pdf(st.session_state.excel_file)
        ...
        if st.session_state.excel_file:
            ...
            """,
                ...
                st.download_button(
                    ...
                    file_name=f"insurance_claims_report_{timestamp}.xlsx",
        ...
        if st.session_state.pdf_file:
            ...
            """,
                ...
                st.download_button(
                    ...
                    file_name=f"insurance_claims_report_{timestamp}.pdf",
